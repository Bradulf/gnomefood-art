...
Story beat: [compact beat from story.md]
Scene memory / previous continuity: [previous scene continuity, or first scene; no previous-scene continuity]
...
Character presence: [assigned character details, or no characters present]
Asset / prop presence: [assigned assets/props, or no props/artifacts present]
